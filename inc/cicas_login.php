...
if ($ci_cas_userid=phpCAS::getUser()) {
	...
	//Authentification et données auteur
		$auteur = array();
	...
	if (isset($auteur['id_auteur'])) {
		//Synchro des données auteur
			$id_auteur = $auteur['id_auteur'];
			//Désactivée car aucune donnée n'est plus récente sur les ENT pour le moment
		...
		// On lui crèe un compte à la volée si c'est possible
			...
			// ajout du répertoire lié si PROF
